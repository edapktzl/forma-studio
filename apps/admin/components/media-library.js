...
export default function MediaLibrary() {
  ...
  return <main className="content">
    ...
    <div className="list-toolbar"><input aria-label={t('Search images')} type="search" placeholder={t('Find a photograph…')} value={query} onChange={(event) => setQuery(event.target.value)} /><span>{t('JPEG, PNG, WebP · 10 MB · MP4 · 20 MB maximum')}</span></div>
