...
export const resources={
 projects:{title:'Projects',singular:'project',intro:'The spaces you create, and the stories behind them.',fields:[text('slug','URL slug',true,{help:'Lowercase letters, numbers and hyphens. Keep this stable after publishing.'}),{key:'category_id',label:'Project category',type:'category',source:'project-categories',required:true},text('location','Location'),number('area_sqm','Area (m²)',false,{min:0}),number('construction_year','Construction year',false,{min:1800,max:2200}),{key:'is_featured',label:'Feature on the homepage',type:'checkbox'}],translations:[text('title','Project title',true,{maxLength:180}),text('concept','Concept',true,{maxLength:240}),text('short_description','Short description',true,{type:'textarea',maxLength:500}),text('description','Project story',true,{type:'textarea'}),text('challenge','The challenge',false,{type:'textarea'}),text('approach','Our approach',false,{type:'textarea'}),text('outcome','The outcome',false,{type:'textarea'})],statuses:['draft','published','archived'],gallery:true},
